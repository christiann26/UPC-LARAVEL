...
@section('content')
    <div style="margin-top: 110px">
        <div class="container">
            <form action="{{ route('carta.actualizar', $carta->id) }}" method="post" enctype="multipart/form-data" class="row justify-content-center">
                @csrf
                <div class="col-4 text-center">
                    ...
                    <div class="form-input text-center">
                        ...
                        <input type="file" id="file-ip-1" name="photo" accept="image/png, image/jpg, image/webp"
                            value="{{ old('photo') }}" onchange="showPreview(event);">
                        @error('photo')
                ...
                <div class="col-4 container1">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nombre" placeholder="Nombre de la carta"
                            value="{{ isset($carta) ? $carta['nombre'] : '' }}" />
                    </div>
                    @error('nombre')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
